...
def num_tokens_from_messages(messages, model="gpt-3.5-turbo-1106"):
    ...
    if model in {
        ...
        raise NotImplementedError(
            f"""Current version does not support model {model}. Consider use the newest version by running `pip install openai_cost_tracker --upgrade` or customize estimator.py and utils.py files. See https://github.com/openai/openai-python/blob/main/chatml.md for more information."""
        )
    num_tokens = 0
